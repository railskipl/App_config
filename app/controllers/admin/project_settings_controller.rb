...
before_filter :authenticate_admin!
	...
	def show
		...
		@setting = Hash["configs" => [{"id":@settings.id,"mobile_app_restrict":@settings.access,"created_at":@settings.created_at,"updated_at":@settings.updated_at}]]  if @setting.present?
